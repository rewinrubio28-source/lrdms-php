...
/**
 * Generate a fresh 6-digit email OTP for a user mid-2FA-login,
 * replacing any earlier unused one. Returns the plain code so the
...
/**
 * Verify a login-step email OTP for a user. On success the code is
