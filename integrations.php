...
$where = [$clause, "({$sub['filter']})"];

if ($q !== '') {
    $where[] = '(d.title LIKE ? OR d.doc_number LIKE ? OR d.sponsor LIKE ?)';
    $like = "%$q%";
...
<<<<<<< HEAD
    ...
    <div class="col-md-3">
      ...
      <input type="text" name="q" value="<?= htmlspecialchars($q) ?>" class="form-control" placeholder="Filter by title, number, or sponsor…" autocomplete="off">
    </div>
    <div class="col-md-2">
    ...
    <div class="col-md-2">
      <label class="form-label small text-muted mb-0">Committee</label>
    ...
    <div class="col-md-2">
      <label class="form-label small text-muted mb-0">Enacted from</label>
      <input type="date" name="date_from" value="<?= htmlspecialchars($dateFrom) ?>" class="form-control">
    </div>
    <div class="col-md-2">
      <label class="form-label small text-muted mb-0">Enacted to</label>
    ...
    <?php if ($q !== '' || $statusFilter !== 'All' || $committeeFilter !== 'All' || $dateFrom !== '' || $dateTo !== ''): ?>
      <div class="col-12">
